...
\subsection{MT1: Tổng hợp và phân loại các bằng chứng trên ảnh tạo sinh}
...
\textbf{1} &
Khảo sát và hệ thống hóa các loại dấu vết tạo sinh. &
Xây dựng hệ thống phân loại các nhóm bằng chứng phục vụ phát hiện, lý giải. \\ \hline

\textbf{2} &
Xây dựng các bộ phát hiện bằng chứng theo nhiều góc nhìn và cơ chế tổng hợp bằng chứng để phân loại ảnh. &
Hệ thống phát hiện ảnh thật/AI-generated dựa trên nhiều loại bằng chứng, có khả năng tổng quát trên nhiều mô hình tạo sinh. \\ \hline
